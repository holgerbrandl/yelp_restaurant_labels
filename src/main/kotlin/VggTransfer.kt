...
internal fun buildVggTransferModel(allTrainDS: DataSet): ComputationGraph? {
    ...
    //    /Users/brandl/projects/deep_learning/dl4j-examples/dl4j-examples/src/main/java/org/deeplearning4j/examples/transferlearning/vgg16/EditLastLayerOthersFrozen.java
    //    // train shape
    //    result = {int[4]@2386}
    //    0 = 15
    //    1 = 3
